...
juce::Typeface::Ptr champLAF::getTypefaceForFont (const juce::Font& font)
{
    return font.isBold() ? sarabunReg : sarabunLight;
}

// Main custom code
void champLAF::drawRotarySlider (juce::Graphics& g, int x, int y, int width, int height, float sliderPos,
...
void champLAF::drawComboBox (juce::Graphics& g, int width, int height, bool,
...
void champLAF::positionComboBoxText (juce::ComboBox& box, juce::Label& label)
{
    label.setBounds (1, 1,
                     box.getWidth() - 2,
                     box.getHeight() - 2);
...
void champLAF::drawTabButton (juce::TabBarButton& button, juce::Graphics& g, bool isMouseOver, bool isMouseDown)
{
